...
public class PdfBoxSignatureService extends AbstractPDFSignatureService {
     ...
     *
     * @param timestamp if true, the instance is used to generate
     * DocumentTypestamp if false, it is used to generate a signature layer
     */
        ...
        for (PDField field : fields) {
            ...
            if (field != null && shallBeLocked.test(field)) {
                ...
                if (field instanceof PDTerminalField) {
                    ((PDTerminalField) field).getWidgets().forEach((widget) -> {
